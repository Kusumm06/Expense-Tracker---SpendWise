...
const AddGoalModal = () => {
  const { isGoalModalOpen, setIsGoalModalOpen, triggerRefresh } = useData();
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-[#334155] transition-colors">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white transition-colors">Create New Goal</h2>
            <button 
